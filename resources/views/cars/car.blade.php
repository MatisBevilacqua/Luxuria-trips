        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                <div class="px-4 py-5 sm:px-6 bg-gray-200">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Add New Car</h3>
                </div>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 bg-gray-200">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">All Cars</h3>
                </div>
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($cars as $car)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ Str::limit($car->description, 30) }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $car->location }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">${{ number_format($car->price_per_hour, 2) }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $car->city }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap flex space-x-2">
                                        <a href="{{ route('car.edit', $car->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                            Edit
                                        </a>
